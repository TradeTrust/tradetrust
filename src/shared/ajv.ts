...
import openAttestationSchemav4 from "../4.0/oa/schema/schema.json";
import tradeTrustSchemav4 from "../4.0/tt/schema/schema.json";
...
export const buildAjv = (
  ...
  ajv.compile(transform(tradeTrustSchemav4));
  return ajv;
};
